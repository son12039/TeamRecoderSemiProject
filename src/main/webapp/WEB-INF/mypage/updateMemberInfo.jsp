		...
		<div class="container">
			...
			<div class="form-group">
				<form action="/updateMemberInfo" method="post" id="form">
					<div class="form-group">
						<label for="nickname" class="input_label"><span style="color: red">*</span>닉네임 <span class="result" id="nicknameResult"></span></label>
						<input type="text" id="nickname" name="nickname"
							placeholder="닉네임을 입력하십시오" value="${member.nickname}" /> 
					</div>
					<div class="form-group">
						<label for="pwd" class="input_label"><span style="color: red">*</span> 비밀번호 <span class="result" id="pwdResult"></span></label>
						<input type="password" id="pwd" name="pwd" placeholder="비밀번호를 입력하십시오."
						 /> 
					</div>
					<div class="form-group">
						<label for="pwdc" class="input_label"><span style="color: red">*</span> 비밀번호 확인<span class="result" id="pwdcResult"></span></label>
						<input type="password" id="pwdc" placeholder="위와 같은 비밀번호를 입력하십시오."
						 /> 
					</div>
					<div class="form-group">
						<label for="name" class="input_label"><span style="color: red">*</span>이름<span class="result" id="nameResult"></span></label>
						<input type="text" id="name" name="name" placeholder="이름을 입력하십시오."
							value="${member.name}" required /> 
					</div>
					<div class="form-group">
						<label for="phone" class="input_label">연락처</label>
						<input type="text" id="phone" name="phone" placeholder="전화번호를 입력하십시오."
							value="${member.phone}"  /> 
					</div>
					<div class="form-group">
						<label for="addr" class="input_label">주소</label>
					...
					<div class="form-group">
						<label for="email" class="input_label"><span style="color: red">*</span>이메일 <span class="result" id="emailResult"></span></label>
						<input type="text" id="email" name="email" placeholder="이메일을 입력해주십시오."
							value="${member.email}"  /> 
					</div>
					<div class="form-group">
						<label for="age" class="input_label"><span style="color: red">*</span>나이<span class="result" id="ageResult"></span></label>
