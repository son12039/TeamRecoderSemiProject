	...
	<div class="container">
		...
		<form action="/update" method="post" id="form">
			<div class="form-group">
				<label>현재 비밀번호</label>
				<p>${mem.pwd}</p>
				<label>변경할 비밀번호</label> <span id="pwdCheck"></span> <input
					type="password" id="pwd" name="pwd" placeholder="pwd" />
			</div>
			<div class="form-group">
				<label>현재 이름</label>
				<p>${mem.name}</p>
				<label>변경할 이름</label> <span id="nameCheck"></span> <input
					type="text" id="name" name="name" placeholder="name" />
			</div>
			<div class="form-group">
				<label>현재 연락처</label>
				<p>연락처 / ${mem.phone}</p>
				<label>변경할 연락처</label> <span id="phoneCheck"></span> <input
			...
			<div class="form-group">
				...
				<label>변경할 이메일</label> <span id="emailCheck"></span> <input
					type="email" id="email" name="email" placeholder="email" />
			</div>
			<div class="form-group">
				<label>나이</label>
				<p>현재 나이 / ${mem.age}</p>
				<label>변경할 나이</label> <span id="ageCheck"></span> <input type="text"
