			...
			<form action="/updateMember" method="post" id="form"
				...
				<div class="profile_update">
					<div class="profile_file">
						...
						<label for="file" class="profile_file_button">사진 선택</label>
					...
					<div class="profile_manner">
						...
						<c:if test="${member.memberManner >= 30 && member.memberManner <= 40}">
							<i class="fa-solid fa-temperature-three-quarters"></i>
							<p>${member.memberManner}℃</p>
					...
					<div class="profile_info">
						<span>한줄소개 : </span> <input type="text" id="memberInfo"
							name="memberInfo" value="${member.memberInfo}" placeholder="소개글을 입력해주세요">
					</div>
					<div class="profile_info">
						<span>취미 : </span> <input type="text" id="memberHobby"
							name="memberHobby" value="${member.memberHobby}" placeholder="취미를 입력해주세요">
					</div>
