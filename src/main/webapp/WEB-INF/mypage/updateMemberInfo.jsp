		...
		<form action="/updateMemberInfo" method="post" id="form">
			<div class="form-group">
				...
				<input type="text" id="nickname" name="nickname"
					placeholder="nickname" value="${mem.nickname}" />
					<span id="nicknameCheck"></span>

			</div>
			<div class="form-group">
				<label>비밀번호 변경</label> <span id="pwdCheck"></span> <input
					type="password" id="pwd" name="pwd" placeholder="pwd" required>
				<label>비밀번호 확인</label> <span id="pwdConfirm"></span> <input
					type="password" id="pwdConfirmCheck" placeholder="pwd" required>
			</div>
			<div class="form-group">
				<label>이름 변경</label> <span id="nameCheck"></span> <input type="text"
					id="name" name="name" placeholder="name" value="${mem.name}"
					required />
			</div>
			<div class="form-group">
				<label>연락처 변경</label> <span id="phoneCheck"></span> <input
					type="tel" id="phone" name="phone" placeholder="phone"
					value="${mem.phone}" required />
			</div>
			<div class="form-group">
				<label>변경할 주소</label>
			...
			<div class="form-group">
				<label>나이 변경</label> <span id="ageCheck"></span> 
				<input type="text" id="age" name="age" placeholder="age" value="${mem.age}" required />
			</div>
			...
			$.ajax({
				...
				success: function (result) {
					if (result){
						...
						alert("이미 있는 닉네임 입니다");
						window.location.href = "redirect:/updateMemberInfo";
					}
